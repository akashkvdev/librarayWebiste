...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>developmentMaterials</title>
                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 <li class="active"> <a href="{{route('Begin')}}">Home</a> </li>
                                 <li> <a href="about.html">About us</a> </li>
                                 {{-- <li><a href="{{route('our_notes')}}">Our Notes</a></li> --}}
                                 <li><a href="{{route('our_library')}}">Our Notes</a></li>
